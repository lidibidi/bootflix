...
app.getMovieById = function getMovieById(id) {
  ...
  success:function(data){
    console.log('huzzah getting by id works!')
    console.log(data);
    console.log(data.Title,data.Plot);
    var movie = new app.MovieModel(data); //new MovieModel object
    var view = new app.MovieView(data); //new MovieView object
    view.render();
...
app.getMovieByTitle = function getMovieByTitle(title) {
  ...
  $.ajax({
   ...
   success:function(data){
     console.log('huzzah get by title works!')
     console.log(data);
